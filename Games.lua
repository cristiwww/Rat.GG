...
SoundEvent:FireServer("newSound", Name, workspace, "http://www.roblox.com/asset/?id=125591827883594", 1, 10, true)
SoundEvent:FireServer("playSound", Name)


task.spawn(function()
    while task.wait(0.25) do
        SoundEvent:FireServer("updateSound", Name, "http://www.roblox.com/asset/?id=125591827883594", 1, 10)
    end
end)
